...
pub(crate) fn init_generic_half_diagonal_ceiling_material(
    ...
    let albedo_texture_handle =
        asset_server.load("models/half_diagonal_template/ceiling/high_base.png");
    let metallic_roughness_texture_handle =
        asset_server.load("models/half_diagonal_template/ceiling/high_metal_rough.png");
    ...
    let albedo_texture_handle =
        asset_server.load("models/half_diagonal_template/ceiling/low_base.png");
    let metallic_roughness_texture_handle =
        asset_server.load("models/half_diagonal_template/ceiling/low_metal_rough.png");
