...
pub(crate) fn init_generic_half_diagonal_floor_material(
    ...
    let albedo_texture_handle =
        asset_server.load("gridmap/half_diagonal_template/generic/floor/high_base.png");
    let metallic_roughness_texture_handle =
        asset_server.load("gridmap/half_diagonal_template/generic/floor/high_metal_rough.png");
    ...
    let albedo_texture_handle =
        asset_server.load("gridmap/half_diagonal_template/generic/floor/low_base.png");
    let metallic_roughness_texture_handle =
        asset_server.load("gridmap/half_diagonal_template/generic/floor/low_metal_rough.png");
