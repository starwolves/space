use bevy::{
    hierarchy::Parent,
    math::{Quat, Vec3},
    prelude::{Commands, Entity, EventReader, EventWriter, Query, Res, ResMut, Transform, With},
};
use bevy_rapier3d::{
    parry::query::Ray,
...
use shared::{
    ...
    gridmap::{cell_id_to_world, get_cell_name, world_to_cell_id, GridmapData, GridmapMain},
    health::{Health, NetHealth},
...
pub fn attack(
    ...
    mut net_message_event: EventWriter<NetHealth>,
