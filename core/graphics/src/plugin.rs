...
use crate::{
    settings::{
        ...
        set_sync_correction, set_vsync, set_window_mode, settings_to_ron, PerformanceSettings,
        SetFxaa, SetMsaa, SetRCAS, SetResolution, SetSyncCorrection, SetVsync, SetWindowMode,
        SettingsSet,
    },
