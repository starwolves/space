    ...
    fn build(&self, app: &mut App) {
        if is_server() {
            app.add_systems(
                ...
                (
                    ...
                    projectile_laser_visuals::<PistolL1>.after(CombatLabels::Query),
                ),
            );
        }
        ...
        app.add_systems(
            ...
            (
                ...
                (build_rigid_bodies::<PistolL1Type>).after(BuildingLabels::TriggerBuild),
                (build_inventory_items::<PistolL1Type>).after(BuildingLabels::TriggerBuild),
                build_pistols_l1::<PistolL1Type>.after(BuildingLabels::TriggerBuild),
            ),
        );
    }
}
