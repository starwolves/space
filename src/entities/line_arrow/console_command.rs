...
use crate::core::{
    ...
    console_commands::commands::InputConsoleCommand,
    entity::{
        load_entity::NetUnloadEntity,
        spawn::{SpawnData, SpawnEvent},
    },
    networking::networking::ConsoleCommandVariantValues,
        ...
        if command.command_name == "pointArrow" {
            ...
            match command.command_arguments.get(0) {
                Some(variant_val) => match variant_val {
                    crate::core::networking::networking::ConsoleCommandVariantValues::Int(_) => {
                        continue;
                    }
                    crate::core::networking::networking::ConsoleCommandVariantValues::String(_) => {
                        continue;
                    }
                    crate::core::networking::networking::ConsoleCommandVariantValues::Float(
                        val,
                    ) => {
                        x = *val;
                    }
                    crate::core::networking::networking::ConsoleCommandVariantValues::Bool(_) => {
                        continue;
                    }
                },
                None => {
