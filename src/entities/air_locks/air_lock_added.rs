...
use crate::{
    core::{
        ...
        entity::entity_data::{DefaultMapEntity, EntityData, EntityGroup},
        examinable::examinable::{Examinable, RichName},
        gridmap::gridmap::{world_to_cell_id, EntityGridData, GridmapMain, Vec2Int},
        map::map_overlay::{MapData, GREEN_MAP_TILE_ENTRANCE},
    },
    entities::air_locks::spawn::{
