...
use crate::{
    core::{
        atmospherics::difussion::{get_atmos_index, AtmosphericsResource},
        chat::message::{FURTHER_ITALIC_FONT, WARNING_COLOR},
        entity::entity_data::EntityGroup,
        examinable::examinable::Examinable,
        gridmap::gridmap::{world_to_cell_id, Vec2Int},
        networking::networking::ReliableServerMessage,
        pawn::pawn::{Pawn, ShipAuthorization, ShipAuthorizationEnum},
        sfx::{
    ...
    entities::{
        air_locks::{air_lock::LockedStatus, air_lock_events::AirLockCloseRequest},
        sounds::counter_window::{
