use bevy::{
    core::Time,
    math::Vec3,
    prelude::{Component, Entity, Local, Query, Res, ResMut, Transform, With, Without},
};
use bevy_rapier3d::prelude::{CoefficientCombineRule, RigidBody, Velocity};
use bevy_renet::renet::RenetServer;
use bincode::serialize;

use crate::core::{
    connected_player::{connection::ConnectedPlayer, plugin::HandleToEntity},
    networking::{networking::UnreliableServerMessage, plugin::RENET_UNRELIABLE_CHANNEL_ID},
    sensable::sensable::Sensable,
};

use super::{disabled::RigidBodyDisabled, rigid_body::CachedBroadcastTransform};
