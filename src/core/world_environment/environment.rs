use bevy::{math::Quat, prelude::ResMut};
use serde::{Deserialize, Serialize};

use crate::core::entity::entity_data::{string_color_to_color, string_quat_to_quat};
...
pub struct WorldEnvironment {
    ...
    pub ambient_light_color: (f32, f32, f32, f32),
    ...
    pub fog_sun_color: (f32, f32, f32, f32),
    ...
    pub ssao_bias: f32,
    pub ssao_blur: u8,
    pub ssao_color: (f32, f32, f32, f32),
