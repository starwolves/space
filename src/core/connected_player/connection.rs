...
use bevy::{
    math::Vec2,
    prelude::{info, Commands, Component, EventWriter, Query, Res, ResMut, Transform},
};

use crate::core::{
    chat::message::get_talk_spaces_setupui,
    configuration::plugin::{ServerId, TickRate},
    console_commands::commands::AllConsoleCommands,
    gridmap::gridmap::GridmapData,
    health::health::ClientHealthUICache,
    humanoid::humanoid::{CharacterAnimationState, Humanoid},
    map::map_overlay::MapData,
    networking::networking::{ReliableServerMessage, ServerConfigMessage},
    pawn::{
        pawn::{ControllerInput, PersistentPlayerData},
        user_name::{AuthidI, UsedNames},
    },
};

use super::{net::NetOnNewPlayerConnection, plugin::HandleToEntity};
