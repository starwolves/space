...
use crate::core::{
    atmospherics::difussion::{get_atmos_index, AtmosphericsResource, DIFFUSION_STEP},
    gridmap::gridmap::{world_to_cell_id, GridmapMain, Vec2Int, FOV_MAP_WIDTH},
    pawn::pawn::Pawn,
    rigid_body::disabled::RigidBodyDisabled,
};

use super::difussion::RigidBodyForcesAccumulation;
