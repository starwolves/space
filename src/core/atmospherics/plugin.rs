...
use crate::core::{
    atmospherics::difussion::{get_atmos_index, Atmospherics, DEFAULT_INTERNAL_AMOUNT},
    gridmap::gridmap::{GridmapData, GridmapMain, Vec2Int, Vec3Int, FOV_MAP_WIDTH},
    map::map_overlay::MapHolders,
    space_plugin::plugin::{MapLabels, PostUpdateLabels, StartupLabels},
};
use bevy::app::CoreStage::PostUpdate;
use bevy::{
    core::FixedTimestep,
    prelude::{
        info, App, CoreStage, ParallelSystemDescriptorCoercion, Plugin, Res, ResMut, SystemLabel,
        SystemSet,
    },
};
...
use super::{
    difussion::{
        atmos_diffusion, AtmosphericsResource, RigidBodyForcesAccumulation, DIFFUSION_STEP,
    },
    effects::atmos_effects,
    map::{atmospherics_map, atmospherics_map_hover},
    net::{net_system, NetAtmosphericsNotices, NetMapDisplayAtmospherics, NetMapHoverAtmospherics},
