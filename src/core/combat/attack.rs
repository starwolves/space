...
use crate::{
    core::{
        ...
        gridmap::{
            fov::ProjectileFOV,
            gridmap::{
                cell_id_to_world, get_cell_name, world_to_cell_id, Cell, GridmapData, GridmapMain,
                Vec3Int,
            },
        },
        health::health::{DamageModel, DamageType, Health, HitResult},
        networking::networking::NetProjectileType,
        physics::physics_events::{get_bit_masks, ColliderGroup},
        ...
        match &attack_event.combat_type {
            ...
            CombatType::Projectile(projectile_type) => {
                match projectile_type {
                    ProjectileType::Laser(laser_color, laser_height, laser_radius, laser_range) => {
                        attack_event.combat_sound_set.spawn_default_sfx(
                            &mut commands,
                            sound_transform,
                            &mut sfx_auto_destroy_timers,
