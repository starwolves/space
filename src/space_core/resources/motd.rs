...
impl FromWorld for MOTD {
    fn from_world(_world: &mut World) -> Self {
        MOTD {
            ...
            "The Star Wolves gaming community is thrilled to have you here, you are invited to connect with our new sovereign gaming community through all our sovereign social platforms!\n" + 
            "[font=" + NEARBY_SHOUT_FONT + "][color=" + COMMUNITY_HREF_COLOR + "][url={\"type\": \"href\",\"data\":\"https://starwolves.io\"}]StarWolves.io[/url][/color][/font]\n" +
            "[/center]",
        }
    }
