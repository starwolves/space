...
use bevy_rapier3d::{na::{UnitQuaternion}, prelude::{RigidBodyPositionComponent, RigidBodyForcesComponent, RigidBodyDominanceComponent, RigidBodyVelocityComponent}, rapier::{ math::{Real, Vector}}};

use crate::space_core::{ecs::{pawn::{components::{PlayerInput, StandardCharacter, LinkedFootstepsWalking, LinkedFootstepsSprinting, Pawn, facing_direction_to_direction, FacingDirection, CharacterAnimationState}, events::{InputMouseAction, InputSelectBodyPart, InputToggleAutoMove, InputAttackEntity, InputAltItemAttack, InputAttackCell}, resources::{HandleToEntity, PlayerYAxisRotations}}, inventory::components::Inventory, inventory_item::components::{InventoryItem, CombatType}, sfx::components::{FootstepsWalking, FootstepsSprinting}, health::events::Attack, static_body::components::StaticTransform, entity::{components::{Examinable, Sensable}, functions::{isometry_to_transform::isometry_to_transform, transform_to_isometry::transform_to_isometry}, events::NetUnloadEntity}, configuration::resources::TickRate}, sfx::actions::{footsteps_walking_sfx::FootstepsWalkingSfxBundle, footsteps_sprinting_sfx::FootstepsSprintingSfxBundle}};
                    ...
                    match inventory_items_query.get(item_entity) {
                        Ok((item_component, examinable_component)) => {
                            ...
                            match item_component.combat_standard_animation {
                                crate::space_core::ecs::inventory_item::components::CombatStandardAnimation::StandardStance => {},
                                crate::space_core::ecs::inventory_item::components::CombatStandardAnimation::PistolStance => {
