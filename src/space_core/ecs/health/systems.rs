        ...
        match &attack_event.combat_type {
            ...
            CombatType::Projectile(projectile_type) => {
                match projectile_type {
                    crate::space_core::ecs::inventory_item::components::ProjectileType::Laser(laser_color, laser_height, laser_radius, laser_range) => {
                    ...
                    crate::space_core::ecs::inventory_item::components::ProjectileType::Ballistic => {},
                }
            },
        }
