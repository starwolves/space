...
use crate::space_core::{ecs::{pawn::components::ConnectedPlayer, health::{components::Health, events::NetHealthUpdate}, networking::resources::{EntityUpdateData, ReliableServerMessage, EntityWorldType}}};
...
pub fn health_ui_update(
    ...
    for (
        ...
        match &health_component.health_container {
            crate::space_core::ecs::health::components::HealthContainer::Humanoid(humanoid_health) => {
