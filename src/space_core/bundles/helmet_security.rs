   ...
   Vec3::new(0.,0.132, 0.05)
    ...
    builder.insert_bundle(
        ...
        InventoryItem {
            ...
            combat_sound_set: MeleeCombatSoundSet {
                miss: "".to_string(),
                hit_soft: "".to_string(),
