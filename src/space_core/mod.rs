...
impl Plugin for SpaceCore {
    fn build(&self, app: &mut App) {
        ...
        .add_system(construction_tool.after(UpdateLabels::TextTreeInputSelection))
        .add_system_set(
            SystemSet::new()
