...
impl Plugin for SpaceCore {
    fn build(&self, app: &mut App) {
        ...
        .add_startup_system(startup_init_atmospherics.label(StartupLabels::InitAtmospherics).after(StartupLabels::BuildGridmap))
        .add_startup_system(startup_launch_server.after(StartupLabels::InitAtmospherics))
        ...
        .add_system(change_display_mode)
        .add_system(request_display_modes)
        .add_system(atmospherics_map
