...
use self::{entities::{air_lock_security::{events::AirLockCollision, systems::{air_lock_events, air_lock_tick_timers}, systems_updates::air_lock_update}, counter_window_security::{events::CounterWindowSensorCollision, systems::{counter_window_events, counter_window_tick_timers}, systems_update::counter_window_update}, construction_tool_admin::{events::{InputConstruct, InputDeconstruct, InputConstructionOptions, InputConstructionOptionsSelection, NetConstructionTool}, systems::construction_tool}, gi_probe::system_updates::gi_probe_update, omni_light::systems_update::omni_light_update, reflection_probe::systems_update::reflection_probe_update}, generics::{inventory::{events::{InputUseWorldItem, InputDropCurrentItem, InputSwitchHands, InputWearItem, InputTakeOffItem, InputThrowItem, NetPickupWorldItem, NetDropCurrentItem, NetSwitchHands, NetWearItem, NetTakeOffItem, NetThrowItem}, systems_update::inventory_update, systems::{pickup_world_item::pickup_world_item, switch_hands::switch_hands, wear_item::wear_item, take_off_item::take_off_item, throw_item::throw_item, drop_current_item::drop_current_item}}, pawn::{events::{InputUIInput, InputSceneReady, InputUIInputTransmitText, InputMovementInput, InputBuildGraphics, InputChatMessage, BoardingPlayer, InputSprinting, InputExamineEntity, InputExamineMap, InputToggleCombatMode, InputMouseDirectionUpdate, InputMouseAction, InputSelectBodyPart, InputToggleAutoMove, InputUserName, InputAttackEntity, InputAltItemAttack, InputAttackCell, InputTabDataEntity, InputTabDataMap, InputTabAction, TextTreeInputSelection, InputConsoleCommand, NetOnNewPlayerConnection, NetOnBoarding, NetOnSetupUI, NetDoneBoarding, NetChatMessage, NetConsoleCommands, NetUserName, NetUIInputTransmitData, NetExamineEntity, NetTabData, NetOnSpawning, NetSendWorldEnvironment, NetSendServerTime, NetUpdatePlayerCount}, systems_update::standard_character_update, systems::{scene_ready_event::scene_ready_event, on_boarding::on_boarding, on_setupui::on_setupui, build_graphics_event::build_graphics_event, chat_message_input_event::chat_message_input_event, done_boarding::done_boarding, on_spawning::on_spawning, examine_entity::examine_entity, examine_map::examine_map, console_commands::console_commands, toggle_combat_mode::toggle_combat_mode, user_name::user_name, tab_data::tab_data, tab_action::tab_action, inventory_tab_data::inventory_tab_data, text_tree_input_selection::text_tree_input_selection, player_input_event::player_input_event, mouse_direction_update::mouse_direction_update, standard_characters::standard_characters, visible_checker::visible_checker, ui_input_event::ui_input_event, ui_input_transmit_data_event::ui_input_transmit_data_event, update_player_count::update_player_count, tick_asana_boarding_announcements::tick_asana_boarding_announcements, send_server_time::send_server_time}, resources::{AuthidI, HandleToEntity, UsedNames, PlayerYAxisRotations, AsanaBoardingAnnouncements}}, inventory_item::systems_update::inventory_item_update, sfx::{systems_update::{repeating_sfx_update, sfx_update}, resources::SfxAutoDestroyTimers, systems::tick_timers_slowed}, health::{events::{NetHealthUpdate, Attack}, systems_update::health_ui_update, systems::attack, resources::ClientHealthUICache}, rigid_body::systems::{broadcast_position_updates::broadcast_position_updates, out_of_bounds_check::out_of_bounds_check, rigidbody_link_transform::rigidbody_link_transform, broadcast_interpolation_transforms::{broadcast_interpolation_transforms, BROADCAST_INTERPOLATION_TRANSFORM_RATE}}, physics::{systems::physics_events, systems_update::world_mode_update}, gridmap::{events::{RemoveCell, NetGridmapUpdates, ProjectileFOV, NetProjectileFOV}, resources::{GridmapData, GridmapMain, GridmapDetails1, DoryenMap, SpawnPoints}, systems::{gridmap_updates::gridmap_updates, senser_update_fov::senser_update_fov, projectile_fov::projectile_fov, remove_cell::remove_cell, startup_init_map_resources::startup_init_misc_resources, startup_init_gridmap_cells::startup_init_map_cells, startup_build_map::startup_build_map}}, entity::{systems_update::send_entity_updates, resources::EntityDataResource, events::{NetLoadEntity, NetUnloadEntity, NetShowcase}, systems::startup_init_entities}, world_environment::resources::WorldEnvironment, configuration::{resources::{TickRate, ServerId, MOTD}}, networking::systems::{net_send_entity_updates::NetSendEntityUpdates, handle_network_events::handle_network_events, handle_network_messages::handle_network_messages, net::net_send_message_event, startup_launch_server::startup_launch_server},}};
...
impl Plugin for SpaceCore {
    fn build(&self, app: &mut App) {
        ...
        .add_startup_system(startup_init_map_cells.label(StartupLabels::InitDefaultGridmapData).after(StartupLabels::Launch))
