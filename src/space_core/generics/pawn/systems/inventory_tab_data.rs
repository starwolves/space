...
use crate::space_core::{generics::{inventory::components::Inventory, pawn::components::Pawn, inventory_item::components::InventoryItem}};
                    ...
                    Some(entity) => {
                        ...
                        match inventory_items.get(entity) {
                            Ok(inventory_item_component) => {
                                for item_tab_action in inventory_item_component.active_slot_tab_actions.iter() {
