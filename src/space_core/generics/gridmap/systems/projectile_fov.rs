...
use crate::space_core::{generics::{pawn::components::{ConnectedPlayer, Senser}, gridmap::{resources::{GridmapMain, GridmapData, Vec3Int, to_doryen_coordinates}, events::{ProjectileFOV, NetProjectileFOV}, functions::gridmap_functions::world_to_cell_id}, networking::resources::{NetProjectileType, ReliableServerMessage}}};
...
pub fn projectile_fov(
    ...
    for event in projectile_fov_events.iter() {
        ...
        match event.laser_projectile {
            NetProjectileType::Laser(laser_color, laser_height, laser_radius, start_pos, end_pos) => {
