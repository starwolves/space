...
use crate::space_core::{generics::{pawn::components::{Senser, ConnectedPlayer}, gridmap::{events::RemoveCell, resources::{GridmapMain, GridmapDetails1, CellUpdate, CellData, StructureHealth, DoryenMap, to_doryen_coordinates}}, networking::resources::GridMapType}};
