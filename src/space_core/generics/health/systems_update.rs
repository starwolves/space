...
use crate::space_core::{generics::{pawn::components::ConnectedPlayer, health::{components::Health, events::NetHealthUpdate}, networking::resources::{EntityUpdateData, ReliableServerMessage, EntityWorldType}}};

use super::resources::{ClientHealthUICache, UIDamageType, ClientHealthUI};
...
pub fn health_ui_update(
    ...
    for (
        ...
        match &health_component.health_container {
            crate::space_core::generics::health::components::HealthContainer::Humanoid(humanoid_health) => {
