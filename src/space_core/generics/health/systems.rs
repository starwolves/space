...
use crate::space_core::{generics::{pawn::{components::Senser, events::NetChatMessage, resources::HandleToEntity}, inventory_item::components::CombatType, health::{components::{Health, HitResult, DamageType}, events::Attack}, gridmap::{components::Cell, resources::{GridmapMain, GridmapData, Vec3Int}, events::ProjectileFOV, functions::{gridmap_functions::{world_to_cell_id, cell_id_to_world}, get_cell_name::get_cell_name}}, sfx::resources::SfxAutoDestroyTimers, entity::components::Examinable, physics::functions::{get_bit_masks, ColliderGroup}, networking::resources::NetProjectileType}};
        ...
        match &attack_event.combat_type {
            ...
            CombatType::Projectile(projectile_type) => {
                match projectile_type {
                    crate::space_core::generics::inventory_item::components::ProjectileType::Laser(laser_color, laser_height, laser_radius, laser_range) => {
                    ...
                    crate::space_core::generics::inventory_item::components::ProjectileType::Ballistic => {},
                }
            },
        }
