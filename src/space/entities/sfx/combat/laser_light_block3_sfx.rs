...
use crate::space::{core::{sfx::components::{Sfx, get_random_pitch_scale}, static_body::components::StaticTransform, entity::components::{EntityData, Sensable, EntityUpdates}}};
...
impl LaserLightBlock3Bundle {
    ...
    pub fn new(passed_transform : Transform) -> (
        ...
        Sfx {
            unit_db: 15.,
            unit_size: 1.,
            stream_id: "laser_light_block3".to_string(),
