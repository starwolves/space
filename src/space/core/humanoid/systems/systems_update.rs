...
use crate::space::{components::{entity_updates::EntityUpdates, showcase::Showcase}, functions::entity_updates::get_entity_update_difference::get_entity_update_difference, resources::network_messages::EntityUpdateData, generics::{pawn::components::{Pawn, StandardCharacter, PersistentPlayerData, PlayerInput, ConnectedPlayer}, inventory::components::Inventory, inventory_item::components::InventoryItem}};
    ...
    for (
        ...
        if standard_character_component.combat_mode {
            ...
            match standard_character_component.current_lower_animation_state {
                crate::space::generics::pawn::components::CharacterAnimationState::Idle => {
                    ...
                    match inventory_item_option {
                        Some(inventory_item_component) => {
                            ...
                            match inventory_item_component.combat_standard_animation {
                                crate::space::generics::inventory_item::components::CombatStandardAnimation::StandardStance => {
                                    upper_body_animation_state = "Idle Heightened".to_string();
                                    lower_body_animation_state = "Idle".to_string();
                                },
                                crate::space::generics::inventory_item::components::CombatStandardAnimation::PistolStance => {
                ...
                crate::space::generics::pawn::components::CharacterAnimationState::Jogging => {
                    ...
                    match pawn_component_option.as_ref().unwrap().facing_direction {
                        crate::space::generics::pawn::components::FacingDirection::UpLeft => {
                            strafe_blend_position = [-1.,1.];
                        },
                        crate::space::generics::pawn::components::FacingDirection::Up => {
                            strafe_blend_position = [0.,1.];
                        },
                        crate::space::generics::pawn::components::FacingDirection::UpRight => {
                            strafe_blend_position = [1.,1.];
                        },
                        crate::space::generics::pawn::components::FacingDirection::Right => {
                            strafe_blend_position = [1.,0.];
                        },
                        crate::space::generics::pawn::components::FacingDirection::DownRight => {
                            strafe_blend_position = [-1.,-1.];
                        },
                        crate::space::generics::pawn::components::FacingDirection::Down => {
                            strafe_blend_position = [0.,-1.];
                        },
                        crate::space::generics::pawn::components::FacingDirection::DownLeft => {
                            strafe_blend_position = [1.,-1.];
                        },
                        crate::space::generics::pawn::components::FacingDirection::Left => {
                            strafe_blend_position = [-1.,0.];
                        },
                    }
                ...
                crate::space::generics::pawn::components::CharacterAnimationState::Sprinting => {
                    upper_body_animation_state = "Idle Heightened".to_string();
                ...
                match active_item_entity {
                    Some(_entity) => {
                        match inventory_item_option.unwrap().combat_attack_animation {
                            crate::space::generics::inventory_item::components::CombatAttackAnimation::OneHandedMeleePunch => {
                            ...
                            crate::space::generics::inventory_item::components::CombatAttackAnimation::PistolShot => {
