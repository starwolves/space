...
use crate::space::core::{map::{events::InputMap, components::Map}, gridmap::resources::FOV_MAP_WIDTH};
            ...
            Ok(mut map_component) => {
                match event.input {
                    crate::space::core::map::events::MapInput::Range(range_x) => {
                        map_component.view_range = range_x.clamp(0.,(FOV_MAP_WIDTH/2)as f32) as usize;
                    },
