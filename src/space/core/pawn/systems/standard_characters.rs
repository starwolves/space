                    ...
                    match inventory_items_query.get(item_entity) {
                        Ok((item_component, examinable_component)) => {
                            ...
                            match item_component.combat_standard_animation {
                                crate::space::core::inventory_item::components::CombatStandardAnimation::StandardStance => {},
                                crate::space::core::inventory_item::components::CombatStandardAnimation::PistolStance => {
