...
use crate::space::{core::{inventory_item::components::InventoryItem, inventory::components::Inventory, entity::{components::{EntityUpdates, Showcase}, functions::get_entity_update_difference::get_entity_update_difference}, networking::resources::EntityUpdateData}};
    ...
    for (
        ...
        if standard_character_component.combat_mode {
            ...
            match standard_character_component.current_lower_animation_state {
                ...
                crate::space::core::pawn::components::CharacterAnimationState::Jogging => {
                ...
                crate::space::core::pawn::components::CharacterAnimationState::Sprinting => {
                    upper_body_animation_state = "Idle Heightened".to_string();
                ...
                match active_item_entity {
                    Some(_entity) => {
                        match inventory_item_option.unwrap().combat_attack_animation {
                            crate::space::core::inventory_item::components::CombatAttackAnimation::OneHandedMeleePunch => {
                            ...
                            crate::space::core::inventory_item::components::CombatAttackAnimation::PistolShot => {
