...
use bevy_internal::{prelude::{error, warn, Query, EventWriter, Res, Entity}, math::Vec3};
...
use crate::space::{
    core::{
        ...
        pawn::{
            components::{
                ConnectedPlayer, PersistentPlayerData, Radio, RadioChannel, SpaceJobsEnum,
            },
...
const TALK_DATA_MACHINE_I_FURTHER_START: &str =
...
const TALK_DATA_MACHINE_NORMAL_FURTHER_START: &str =
...
const SHOUT_DATA_STANDARD_NEARBY_I_START: &str =
...
const SHOUT_DATA_STANDARD_FURTHER_I_START: &str =
...
const SHOUT_DATA_STANDARD_FAR_I_START: &str =
...
const SHOUT_DATA_MACHINE_NEARBY_I_START: &str =
    "[font=res://assets/fonts/SourceCodePro/SourceCodePro-ChatShoutBoldItalicDyna.tres]";
const SHOUT_DATA_MACHINE_NEARBY_I_END: &str = "[/font]";

const SHOUT_DATA_MACHINE_FURTHER_I_START: &str =
    "[font=res://assets/fonts/SourceCodePro/SourceCodePro-ChatShoutBoldItalicDynaSmall.tres]";
const SHOUT_DATA_MACHINE_FURTHER_I_END: &str = "[/font]";

const SHOUT_DATA_MACHINE_FAR_I_START: &str =
    "[font=res://assets/fonts/SourceCodePro/SourceCodePro-ChatShoutBoldItalicDynaSmaller.tres]";
