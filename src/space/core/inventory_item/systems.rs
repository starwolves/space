...
use crate::space::core::{
    ...
    console_commands::{
        events::NetConsoleCommands, functions::rcon_spawn_held_entity::rcon_spawn_held_entity,
...
pub fn inventory_item_console_commands(
    queue: Res<QueuedConsoleCommands>,
    ...
    for console_command_event in queue.queue.iter() {
        ...
        if console_command_event.command_name == "spawn_held_entity" {
            let entity_name;
