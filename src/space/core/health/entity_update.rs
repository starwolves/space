...
use crate::space::{core::{pawn::components::ConnectedPlayer, health::{components::Health, events::NetHealthUpdate}, networking::resources::{EntityUpdateData, ReliableServerMessage, EntityWorldType}}};
...
pub fn health_ui_update(
    ...
    for (
        ...
        match &health_component.health_container {
            crate::space::core::health::components::HealthContainer::Humanoid(humanoid_health) => {
