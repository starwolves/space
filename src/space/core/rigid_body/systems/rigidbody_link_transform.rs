...
use bevy_internal::prelude::{QuerySet, QueryState, Entity, Without, warn};
use bevy_rapier3d::prelude::RigidBodyPositionComponent;

use crate::space::core::{
    entity::components::Showcase, rigid_body::components::RigidBodyLinkTransform,
};
...
pub fn rigidbody_link_transform(
    ...
    {
        if rigid_body_link_transform_component.active {
            rigidbody_position_component.position = *linked_with_new_positions.get(&entity).expect(
