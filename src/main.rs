...
use space_core::{events::{general::{attack::Attack, input_alt_item_attack::InputAltItemAttack, input_attack_entity::InputAttackEntity, input_mouse_action::InputMouseAction, input_select_body_part::InputSelectBodyPart, input_toggle_auto_move::InputToggleAutoMove, input_toggle_combat_mode::InputToggleCombatMode, input_user_name::InputUserName, mouse_direction_update::MouseDirectionUpdate, projectile_fov::ProjectileFOV, scene_ready::SceneReady, ui_input::UIInput, ui_input_transmit_text::UIInputTransmitText}, net::{net_projectile_fov::NetProjectileFOV, net_done_boarding::NetDoneBoarding, net_examine_entity::NetExamineEntity, net_health_update::NetHealthUpdate, net_load_entity::NetLoadEntity, net_on_boarding::NetOnBoarding, net_on_new_player_connection::NetOnNewPlayerConnection, net_on_setupui::NetOnSetupUI, net_send_entity_updates::NetSendEntityUpdates, net_ui_input_transmit_data::NetUIInputTransmitData, net_user_name::NetUserName}}, resources::{all_ordered_cells::AllOrderedCells, authid_i::AuthidI, blackcells_data::BlackcellsData, client_health_ui_cache::ClientHealthUICache, doryen_fov::{DoryenMap}, handle_to_entity::HandleToEntity, motd::MOTD, non_blocking_cells_list::NonBlockingCellsList, server_id::ServerId, spawn_points::{SpawnPoints}, tick_rate::TickRate, used_names::UsedNames, world_environments::{WorldEnvironment}}, systems::{entity_updates::{health_ui_update::health_ui_update, omni_light_update::omni_light_update, send_entity_updates::send_entity_updates}, general::{alt_item_attack::alt_item_attack, attack::attack, broadcast_interpolation_transforms::BROADCAST_INTERPOLATION_TRANSFORM_RATE, done_boarding::done_boarding, mouse_direction_update::mouse_direction_update, on_boarding::on_boarding, on_setupui::on_setupui, on_spawning::on_spawning, projectile_fov::projectile_fov, scene_ready_event::scene_ready_event, toggle_combat_mode::toggle_combat_mode, ui_input_event::ui_input_event, ui_input_transmit_data_event::ui_input_transmit_data_event, user_name::user_name, visible_checker::visible_checker}}};
...
fn main() {
    ...
    App::build()
        ...
        .add_system(alt_item_attack.system())
        ...
        .add_system(standard_characters.system().label(UpdateLabels::MoveStandardCharacters).after(UpdateLabels::ProcessMovementInput))
        .add_system(attack.system().after(UpdateLabels::MoveStandardCharacters))
