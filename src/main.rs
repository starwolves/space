...
//            auto_heartbeat_ms: Some(1000),
        ...
        .add_event::<RconAuthorization>()
        .add_event::<NetRconAuthorization>()
        ...
        .add_system(rcon_authorization_event.system())
