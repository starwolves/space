...
fn main() {
    ...
    App::build()
        ...
        .add_startup_system(startup_build_gridmap.system().label(StartupLabels::BuildGridmap).after(StartupLabels::InitDefaultGridmapData))
        ...
        .add_system(drop_current_item.system().label(UpdateLabels::DropCurrentItem).before(UpdateLabels::StandardCharacters))
        ...
        .add_system(throw_item.system().before(UpdateLabels::StandardCharacters))
