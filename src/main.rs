...
use space_core::{events::{general::{input_mouse_action::InputMouseAction, input_ooc_name::InputOocName, input_select_body_part::InputSelectBodyPart, input_toggle_auto_move::InputToggleAutoMove, input_toggle_combat_mode::InputToggleCombatMode, mouse_direction_update::MouseDirectionUpdate, scene_ready::SceneReady, ui_input::UIInput, ui_input_transmit_text::UIInputTransmitText}, net::{net_done_boarding::NetDoneBoarding, net_load_entity::NetLoadEntity, net_on_boarding::NetOnBoarding, net_on_new_player_connection::NetOnNewPlayerConnection, net_on_setupui::NetOnSetupUI, net_ooc_name::NetOocName, net_send_entity_updates::NetSendEntityUpdates, net_ui_input_transmit_data::NetUIInputTransmitData}}, resources::{all_ordered_cells::AllOrderedCells, authid_i::AuthidI, blackcells_data::BlackcellsData, doryen_fov::{DoryenMap}, handle_to_entity::HandleToEntity, motd::MOTD, non_blocking_cells_list::NonBlockingCellsList, server_id::ServerId, spawn_points::{SpawnPoints}, tick_rate::TickRate, used_names::UsedNames, world_environments::{WorldEnvironment}}, systems::{entity_updates::{
            omni_light_update::omni_light_update,
            send_entity_updates::send_entity_updates
        }, general::{broadcast_interpolation_transforms::BROADCAST_INTERPOLATION_TRANSFORM_RATE, done_boarding::done_boarding, mouse_direction_update::mouse_direction_update, on_boarding::on_boarding, on_setupui::on_setupui, on_spawning::on_spawning, ooc_name::ooc_name, scene_ready_event::scene_ready_event, toggle_combat_mode::toggle_combat_mode, ui_input_event::ui_input_event, ui_input_transmit_data_event::ui_input_transmit_data_event, visible_checker::visible_checker}}};
...
fn main() {
    ...
    App::build()
        ...
        .add_event::<InputOocName>()
        .add_event::<NetOocName>()
